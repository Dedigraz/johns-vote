...
-- AddForeignKey
ALTER TABLE "Submission" ADD CONSTRAINT "Submission_submissionGroupId_fkey" FOREIGN KEY ("submissionGroupId") REFERENCES "SubmissionGroup"("id") ON DELETE SET NULL ON UPDATE CASCADE;
